...
.. code-block:: bash
    ...
    # Usage
    python csv_to_npz.py --input_file dance1_subject2.csv --input_fps 30 --frame_range 122 722 --output_fps 50
"""
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene, joint_names: list[str]):
    ...
    # Load motion
    motion = MotionLoader(
        motion_file=f"{GR1T2_MOTION_DIR}/animation/{args_cli.input_file}/{args_cli.input_file}.csv",
    ...
    while simulation_app.is_running():
        ...
        if reset_flag and not file_saved:
            ...
            np.savez(f"{GR1T2_MOTION_DIR}/animation/{args_cli.input_file}/{args_cli.input_file}.npz", **log)
