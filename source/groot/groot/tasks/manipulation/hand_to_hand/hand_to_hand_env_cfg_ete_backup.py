...
class RewardsCfg:
    ...
    hands_proximity = RewTerm(func=mdp.rew_hands_proximity, weight=4.0, params={"min_height": 0.85})
    ...
    dual_hold = RewTerm(func=mdp.rew_dual_hold_bonus, weight=4.0, params={"dist_th": 0.10})
    ...
    close_bonus = RewTerm(
        ...
        weight=60.0,
        params={"hand_obj_thresh": 0.15, "hand_sep_thresh": 0.25, "min_height": 0.86, "vel_thresh": 0.22},
    )
    ...
    release_penalty = RewTerm(func=mdp.rew_release_penalty, weight=3.0, params={"dist_th": 0.06})
...
class TerminationsCfg:
    ...
    object_at_rest = DoneTerm(
        func=mdp.object_at_rest_on_table, params={"vel_thresh": 0.05, "height_thresh": 0.9, "settle_steps": 10}
    )
