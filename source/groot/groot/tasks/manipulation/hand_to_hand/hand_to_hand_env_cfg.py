...
class ActionsCfg:
    ...
    symmetric_hands = mdp.SymmetricDualIKActionCfg(
        ...
        disable_grasp=False,  # allow grip commands to actuate fingers
        center_z_floor=1.0,
...
class GR1T2HandToHandEnvCfg(ManagerBasedRLEnvCfg):
    ...
    debug_left_use_ref_pos: bool = True
    debug_lateral_bias: float = 0.0
    debug_post_grasp_sep_m: float = 0.15
    debug_post_grasp_sep_ratio: float = 0.25
