...
```
git clone --recursive https://github.com/S-CHOI-S/Bimanual-Manipulation-GR1T2.git groot
```
...
```
>[!Tip]
> Bimanual-Manipulation-GR1T2 is compatible with `rsl_rl`, `Stable Baselines3`, as well as custom reinforcement learning algorithms.
